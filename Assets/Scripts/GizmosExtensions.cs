...
public class GizmosExtensions
{
    ...
    public static void DrawWireArc(Vector3 position, Vector3 dir, float anglesRange, float radius,bool drawInnerLine = false, float maxSteps = 20)
    {
